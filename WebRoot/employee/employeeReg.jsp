...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <h2>新增员工</h2>
    <div class="div_main">
            <form action="${pageContext.request.contextPath }/saveEmployee" id="empForm" method="post">
                    <div class="div_top">
                    ...
                    <div class="div_top">
                        ...
                        <input class="input_left" type="radio" name="emp.gender" value="男" id="empsex1" checked="checked"/>男
                        <input class="input_left" type="radio" name="emp.gender" value="女" id="empsex2"/>女
