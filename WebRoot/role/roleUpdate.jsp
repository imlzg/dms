                ...
                <div id="content">
                    <div class="contert_nav">
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath }/listRole.action?pageNum.page=${pageNum.page}&searchRole.name=${searchRole.name}">信息列表</a></li>
                        </ul>
                    </div>
                    <div class="contert_main">
                        <h3>角色管理>>编辑信息</h3>
                        <div class="area_conterner public business_x_height">
                            <form action="${pageContext.request.contextPath }/doEditRole?pageNum.page=${pageNum.page}&searchRole.name=${searchRole.name}" id="empForm" method="post">
                                <div class="webmaster_main">
                                    ...
                                    <p>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;描述
                                        <s:textfield cssClass="W_input" name="role.descr" theme="simple" id="email"></s:textfield>
                                        <span id="emailTip" style="font-size: 12px; color: #CD0000;"></span>
                                    </p>
                                    <p>
                                        <input type="submit" id="sub" value="更新" class="btn_bg" />
